...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('root/css/styles-merged.css') }}">
    <link rel="stylesheet" href="{{ asset('root/css/style.min.css') }}">
    <link rel="stylesheet" href="{{ asset('root/css/vendor/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('root/css/custom.css') }}">
