...
<!--
  Theme Name: lorem
  Theme URL: https://probootstrap.com/lorem-free-education-responsive-bootstrap-website-template
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-9 col-md-9 col-sm-9 probootstrap-top-quick-contact-info">
                        <span><i class="icon-location2"></i>plot f44 mpingwe malawi</span>
                        <span><i class="icon-phone2"></i>+1-123-456-7890</span>
                        <span><i class="icon-mail"></i>cyhperk@gmail.com</span>
                    </div>
                        ...
                        <div class="probootstrap-flex-block">
                            <div class="probootstrap-text probootstrap-animate">
                                ...
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis explicabo veniam labore
                                    ratione illo vero voluptate a deserunt incidunt odio aliquam commodi blanditiis
                                    voluptas error non rerum temporibus optio accusantium!</p>
                                                ...
                                                <a href="#" class="probootstrap-featured-news-box">
                                                    ...
                                                    <div class="probootstrap-text">
                                                        ...
                                                        <span class="probootstrap-date"><i
                                                                class="icon-calendar"></i>July 9, 2017</span>
                                                ...
                                                <a href="#" class="probootstrap-featured-news-box">
                                                    ...
                                                    <div class="probootstrap-text">
                                                        ...
                                                        <span class="probootstrap-location"><i
                                                                class="icon-location2"></i>White Palace, Brooklyn,
                                                            NYC</span>
                                                    </div>
                                                </a>
                                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="probootstrap-service-2 probootstrap-animate">
                            ...
                            <div class="text">
                                ...
                                <p>Laboriosam pariatur modi praesentium deleniti molestiae officiis atque numquam quos
                                    quis nisi voluptatum architecto rerum error.</p>
                        ...
                        <div class="owl-carousel owl-carousel-testimony owl-carousel-fullwidth">
                            <div class="item">
                                ...
                                <div class="probootstrap-testimony-wrap text-center">
                                    ...
                                    <blockquote class="quote">&ldquo;Design must be functional and functionality must
                                        be translated into visual aesthetics, without any reliance on gimmicks that have
                                        to be explained.&rdquo; <cite class="author"> &mdash; <span>Mike
                                                Fisher</span></cite></blockquote>
                                </div>
                            ...
                            <div class="item">
                                <div class="probootstrap-testimony-wrap text-center">
                                    ...
                                    <blockquote class="quote">&ldquo;Creativity is just connecting things. When you
                                        ask creative people how they did something, they feel a little guilty because
                                        they didn’t really do it, they just saw something. It seemed obvious to them
                                        after a while.&rdquo; <cite class="author"> &mdash;<span>Jorge
                            ...
                            <div class="item">
                                <div class="probootstrap-testimony-wrap text-center">
                                    ...
                                    <blockquote class="quote">&ldquo;I think design would be better if designers were
                                        much more skeptical about its applications. If you believe in the potency of
                                        your craft, where you choose to dole it out is not something to take
                                        lightly.&rdquo; <cite class="author">&mdash; <span>Brandon White</span></cite>
                                    </blockquote>
                                </div>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="probootstrap-footer-widget">
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro provident suscipit natus a
                                ...
                                provident dolor ab aliquam eveniet alias</p>
                            <h3>Social</h3>
                            <ul class="probootstrap-footer-social">
                                <li><a href="#"><i class="icon-twitter"></i></a></li>
                    ...
                    <div class="col-md-4">
                        <div class="probootstrap-footer-widget">
                            ...
                            <ul class="probootstrap-contact-info">
                                <li><i class="icon-location2"></i> <span>198 West 21th Street, Suite 721 New York NY
                                        10016</span></li>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 text-left">
                            <p>&copy; 2017 <a href="#">Techlink360</a>. All Rights Reserved. Designed &amp;
                                Developed with <i class="icon icon-heart"></i> by <a href="#">Techlink360</a>
                            </p>
                        </div>
                        <div class="col-md-4 probootstrap-back-to-top">
                            <p><a href="#" class="js-backtotop">Back to top <i
                                        class="icon-arrow-long-up"></i></a></p>
                        </div>
                    </div>
                </div>
            </div>
