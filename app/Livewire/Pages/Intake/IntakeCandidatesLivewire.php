...
class IntakeCandidatesLivewire extends Component
{
    ...
    public function info($id)
    {
        ...
        $this->programs = CandidateProgram::join('educational_programs','educational_programs.id','=','candidate_programs.educational_programs_id')->where('intake_candidate_id',$this->candidate->id)->get();
        dd($this->programs);
        $this->modal = true;
    }
